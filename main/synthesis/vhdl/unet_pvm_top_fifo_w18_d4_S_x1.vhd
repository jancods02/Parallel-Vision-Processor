...
entity unet_pvm_top_fifo_w18_d4_S_x1 is 
    generic (
...
architecture rtl of unet_pvm_top_fifo_w18_d4_S_x1 is
------------------------Task and function--------------
------------------------Parameter----------------------
constant SRL_DEPTH  : INTEGER := DEPTH;
constant SRL_AWIDTH : INTEGER := ADDR_WIDTH;
------------------------Component----------------------
    component unet_pvm_top_fifo_w18_d4_S_x1_ShiftReg is
    generic (
        DATA_WIDTH : integer := 18;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 4);
...
begin
----------------------- Instantiation -----------------------
    U_unet_pvm_top_fifo_w18_d4_S_x1_ShiftReg : unet_pvm_top_fifo_w18_d4_S_x1_ShiftReg
    generic map (
...
entity unet_pvm_top_fifo_w18_d4_S_x1_ShiftReg is
    generic (
        DATA_WIDTH : integer := 18;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 4);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end unet_pvm_top_fifo_w18_d4_S_x1_ShiftReg;

architecture rtl of unet_pvm_top_fifo_w18_d4_S_x1_ShiftReg is
