...
entity unet_pvm_top_start_for_forward_6_U0 is 
    generic (
...
architecture rtl of unet_pvm_top_start_for_forward_6_U0 is
------------------------Task and function--------------
------------------------Parameter----------------------
constant SRL_DEPTH  : INTEGER := DEPTH;
constant SRL_AWIDTH : INTEGER := ADDR_WIDTH;
------------------------Component----------------------
    component unet_pvm_top_start_for_forward_6_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
...
begin
----------------------- Instantiation -----------------------
    U_unet_pvm_top_start_for_forward_6_U0_ShiftReg : unet_pvm_top_start_for_forward_6_U0_ShiftReg
    generic map (
...
entity unet_pvm_top_start_for_forward_6_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end unet_pvm_top_start_for_forward_6_U0_ShiftReg;

architecture rtl of unet_pvm_top_start_for_forward_6_U0_ShiftReg is
