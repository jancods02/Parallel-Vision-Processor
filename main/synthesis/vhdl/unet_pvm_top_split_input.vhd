...
entity unet_pvm_top_split_input is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of unet_pvm_top_split_input is 
...
attribute shreg_extract : string;
    ...
    signal t_7_fu_78_p2 : STD_LOGIC_VECTOR (4 downto 0);
...
begin
    ...
    ap_block_state2_pp0_stage0_iter1_grp1_assign_proc : process(mamba_in_3_empty_n, s_res_full_n, s_in_norm_full_n)
    begin
                ap_block_state2_pp0_stage0_iter1_grp1 <= ((s_in_norm_full_n = ap_const_logic_0) or (s_res_full_n = ap_const_logic_0) or (mamba_in_3_empty_n = ap_const_logic_0));
    end process;
    ...
    icmp_ln8_fu_72_p2 <= "1" when (ap_sig_allocacmp_t = ap_const_lv5_10) else "0";

    mamba_in_3_blk_n_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, mamba_in_3_empty_n, ap_block_pp0_stage0_grp1)
    begin
    ...
    mamba_in_3_read_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_11001_grp1)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001_grp1) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            mamba_in_3_read <= ap_const_logic_1;
        else 
            mamba_in_3_read <= ap_const_logic_0;
        end if; 
    end process;
    ...
    t_7_fu_78_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_t) + unsigned(ap_const_lv5_1));
end behav;
