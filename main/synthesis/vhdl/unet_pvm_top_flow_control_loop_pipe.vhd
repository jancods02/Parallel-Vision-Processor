...
entity unet_pvm_top_flow_control_loop_pipe is
port (
    ap_clk             : in  std_logic;
    ap_rst             : in  std_logic;
...
end entity unet_pvm_top_flow_control_loop_pipe;

architecture behav of unet_pvm_top_flow_control_loop_pipe is
begin 
