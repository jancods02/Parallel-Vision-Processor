...
module unet_pvm_top_split_input_14 (
        ap_clk,
        ap_rst,
        ap_start,
        start_full_n,
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001_grp1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        mamba_in_2_read = 1'b1;
    end else begin
        mamba_in_2_read = 1'b0;
    end
end
...
always @ (*) begin
    ap_block_state2_pp0_stage0_iter1_grp1 = ((s_in_norm_full_n == 1'b0) | (s_res_full_n == 1'b0) | (mamba_in_2_empty_n == 1'b0));
end
...
assign icmp_ln8_fu_72_p2 = ((ap_sig_allocacmp_t_5 == 5'd16) ? 1'b1 : 1'b0);

assign s_in_norm_din = mamba_in_2_dout;

assign s_res_din = mamba_in_2_dout;

assign start_out = real_start;

assign t_6_fu_78_p2 = (ap_sig_allocacmp_t_5 + 5'd1);

endmodule //unet_pvm_top_split_input_14
